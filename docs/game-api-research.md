...
| Transformers | `PowerTransformer`, `Battery` | Historical research only | Not planned | Transformer efficiency is excluded from the roadmap; transformers remain vanilla |
...
| Electrical circuits | `CircuitManager`, `EnergyConsumer` | Historical research only | Not planned | Resistance, voltage-drop, brownouts, and custom power routing are excluded from the roadmap |
